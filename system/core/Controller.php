    ...
    function isLogin($tab) {
        ...
        switch ($perfil) {
            ...
            case "empleado_rrpp":
                ...
                break;   
            case "secretaria":
                $privilegios = array("cambiar_password", "crear_alumno", "crear_abono_matricula", "crear_factura", "crear_recibo_caja", "consultar_sede", "consultar_salon", "consultar_titular", "consultar_alumno");
                if (!in_array($tab, $privilegios))
                    redirect(base_url() . 'login');
                break;   
            case "titular":
