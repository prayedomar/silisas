...
class CI_Controller {
    ...
    function isLogin($tab) {
        ...
        switch ($perfil) {
            case "admon_sistema":
                $privilegios = array("cambiar_password", "crear_sede", "crear_salon", "crear_salario", "crear_empleado", "crear_sede_secundaria", "crear_despachar_placa", "crear_recibir_placa", "crear_ausencia_laboral", "crear_llamado_atencion", "crear_titular", "crear_alumno", "crear_cliente", "crear_proveedor", "crear_caja", "crear_cuenta", "crear_asignar_cuenta_sede", "crear_asignar_cuenta_empleado", "crear_adelanto", "crear_prestamo", "crear_abono_adelanto", "crear_abono_prestamo", "crear_ingreso", "crear_retefuente", "crear_nota_credito", "crear_egreso", "crear_pago_proveedor", "crear_abono_matricula", "crear_factura", "crear_recibo_caja", "crear_nomina", "crear_contrato_matricula", "crear_matricula", "crear_liquidar_comisiones", "crear_traslado_contrato_matricula", "editar_sedes_empleado", "editar_cargo_jefe_rrpp", "editar_alumno", "editar_plan_matricula", "consultar_sede", "consultar_salon", "consultar_salario", "consultar_empleado", "consultar_ausencia_laboral", "consultar_llamado_atencion", "consultar_titular", "consultar_alumno", "consultar_cliente", "consultar_proveedor", "consultar_caja", "consultar_cuenta", "consultar_transacciones", "consultar_adelanto", "consultar_abono_adelanto", "consultar_ingreso", "consultar_retefuente", "consultar_egreso", "consultar_retefuente", "consultar_pago_proveedor", "consultar_nota_credito", "consultar_factura", "consultar_recibo_caja", "consultar_matricula", "consultar_liquidar_comisiones");
