    ...
    function isLogin($tab) {
        ...
        switch ($perfil) {
            ...
            case "directivo":
                ...
                break;
            case "admon_sede":
                $privilegios = array("cambiar_password", "crear_empleado", "crear_despachar_placa", "crear_recibir_placa", "crear_ausencia_laboral", "crear_llamado_atencion", "crear_titular", "crear_alumno", "crear_proveedor", "crear_adelanto", "crear_abono_adelanto", "crear_ingreso", "crear_egreso", "crear_abono_matricula", "crear_factura", "crear_recibo_caja", "crear_nomina", "crear_matricula", "crear_liquidar_comisiones", "editar_cargo_jefe_rrpp", "editar_alumno", "editar_plan_matricula", "consultar_sede", "consultar_salon", "consultar_salario", "consultar_empleado", "consultar_ausencia_laboral", "consultar_llamado_atencion", "consultar_titular", "consultar_alumno", "consultar_proveedor", "consultar_transacciones", "consultar_matricula", "consultar_liquidar_comisiones");
                if (!in_array($tab, $privilegios))
                    redirect(base_url() . 'login');
                break;   
            case "aux_admon":
                $privilegios = array("cambiar_password", "crear_empleado", "crear_despachar_placa", "crear_abono_matricula", "crear_factura", "crear_recibo_caja", "editar_alumno", "consultar_sede", "consultar_salon", "consultar_empleado",  "consultar_titular", "consultar_alumno", "consultar_proveedor", "consultar_matricula", "consultar_liquidar_comisiones");
                if (!in_array($tab, $privilegios))
                    redirect(base_url() . 'login');
                break;        
            case "cartera":
                $privilegios = array("cambiar_password", "crear_abono_matricula", "crear_factura", "crear_recibo_caja", "consultar_sede", "consultar_salon", "consultar_empleado", "consultar_titular", "consultar_alumno", "consultar_proveedor", "consultar_matricula", "consultar_liquidar_comisiones");
                if (!in_array($tab, $privilegios))
                    redirect(base_url() . 'login');
                break; 
            case "contador":
            ...
            case "empleado_rrpp":
                ...
                break;   
            case "secretaria":
                $privilegios = array("cambiar_password", "crear_abono_matricula", "crear_factura", "crear_recibo_caja", "editar_alumno", "consultar_sede", "consultar_salon", "consultar_titular", "consultar_alumno", "consultar_matricula");
                if (!in_array($tab, $privilegios))
                    redirect(base_url() . 'login');
                break;   
            case "titular":
