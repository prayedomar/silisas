    ...
    function isLogin($tab) {
        ...
        switch ($perfil) {
            ...
            case "admon_sede":
                ...
                break;   
            case "aux_admon":
                $privilegios = array("cambiar_password", "crear_titular",  "crear_alumno", "crear_matricula", "crear_empleado", "crear_despachar_placa", "crear_abono_matricula", "crear_factura", "crear_recibo_caja", "aprobar_transferencia", "editar_alumno", "consultar_sede", "consultar_salon", "consultar_empleado",  "consultar_titular", "consultar_alumno", "consultar_proveedor", "consultar_matricula", "consultar_liquidar_comisiones", "consultar_factura", "consultar_recibo_caja", "consultar_transferencia", "consultar_plan_pagos", "consultar_pagos_matricula");
                if (!in_array($tab, $privilegios))
                    redirect(base_url() . 'login');
                break;        
            case "jefe_cartera":
                $privilegios = array("cambiar_password", "crear_abono_matricula", "crear_factura", "crear_recibo_caja", "aprobar_transferencia", "consultar_sede", "consultar_salon", "consultar_empleado", "consultar_titular", "consultar_alumno", "consultar_proveedor", "consultar_matricula", "consultar_liquidar_comisiones", "consultar_factura", "consultar_recibo_caja", "consultar_transferencia", "consultar_plan_pagos", "consultar_pagos_matricula", "crear_descuento_matricula");
                if (!in_array($tab, $privilegios))
                    redirect(base_url() . 'login');
                break; 
            case "cartera":
