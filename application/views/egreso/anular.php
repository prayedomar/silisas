    ...
    <div class="row">
        <div class="col-xs-12 thumbnail">
            <form role="form" method="post" action="{action_crear}" id="formulario">
                <div class="row">
                    <legend>Anular egreso</legend><p class="required_alert"><em class="required_asterisco">*</em> Campos Obligatorios</p> 
                    <div class="row">
                        <div class="col-xs-6 col-xs-offset-3">
                            <legend>Egreso que se anulará</legend>
                            ...
                            <div class="row text-center separar_submit">
                                ...
                                <a href='{action_recargar}' class="btn btn-default" role="button"><span class="glyphicon glyphicon-user"></span> Seleccionar otro egreso </a>
                            </div>
                        </div>
                    </div>
                </div>
                <div id="div_anular" style="display: none">
                    <div class="row">
                        <legend>Información del egreso</legend>
                        ...
                        <div class="form-group separar_submit">
                            ...
                            <center>
                                ...
                                <button id="btn_validar" class="btn btn-success">Anular egreso</button>  
...
<script type="text/javascript">
    $("form").delegate("#consultar_transaccion", "click", function() {
        ...
        if ((prefijo != "default") && (id != "")) {
            ...
            $("#validacion_inicial").html('<div class="alert alert-warning" id="div_warning"></div>');
            $("#div_warning").html("<p><strong><center>Antes de consultar, ingrese el prefijo y el consecutivo del egreso que se anulará.</center></strong></p>");
            $("#div_warning").delay(8000).fadeOut(1000);
        }
    });
