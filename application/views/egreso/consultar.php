                    ...
                    <div class="row">
                        <div class="col-xs-4 col-xs-offset-4">
                            ...
                            <div class="form-group">
                                <input name="prefijo_id_egreso" id="prefijo_id_egreso" type="text" class="form-control letras_numeros" placeholder="Código del egreso" maxlength="18" onkeyup="aMays(event, this)" onblur="aMays(event, this)" autofocus="autofocus">
                            </div>
