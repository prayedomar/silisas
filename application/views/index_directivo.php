        ...
        <div class="navbar-collapse collapse navbar-responsive-collapse">
            <ul class="nav navbar-nav">
                    ...
                    <ul class="dropdown-menu dropdown-menu-large row" style="margin-left: 175px;">
                        <li class="col-sm-3">
                            <ul>
                                ...
                                <li><a href="{base_url}index_admon_sistema/crear_salario">Salario</a></li>
                                <li><a href="{base_url}index_admon_sistema/crear_asignar_sede">Asignar Sedes</a></li>
                                <li><a href="#">Entrega de Placas</a></li>
                ...
                <li class="dropdown dropdown-large">
                    ...
                    <ul class="dropdown-menu dropdown-menu-large row" style="margin-left: 270px;">
                        <li class="col-sm-3">
                            <ul>
                                <li class="dropdown-header">Sedes</li>
                                <li><a href="{base_url}index_admon_sistema/crear_sede">Sede</a></li>
                                ...
                                <li class="divider"></li>                                    
                                <li class="dropdown-header">Empleados</li>
                                <li><a href="{base_url}index_admon_sistema/editar_cargo_jefe">Cargo y Jefe</a></li>
