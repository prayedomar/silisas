<div class="contenidoperm">
    <div class="row">
        <div class="col-xs-12 thumbnail"> 
            <div class="row">
                <legend>Autorizar cuentas bancaria a empleados para <U>RETIRAR DINERO</U></legend><p class="required_alert"><em class="required_asterisco">*</em> Campos Obligatorios</p> 
                <div class="col-xs-12">
