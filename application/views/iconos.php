<!DOCTYPE html>
<html lang="en"><head>
        <link href="<?php echo base_url() ?>libraries/bootstrap_3.0.2/css_default/bootstrap.min.css" rel="stylesheet">
        ...
        <script src="icono_files/track.js" data-site-id="4f0dc9fef5a1f55508000013" id="gauges-tracker" async=""></script><script src="icono_files/azcarbon_2_1_0_HORIZ" async=""></script><script src="icono_files/ga.js" async=""></script><script>
            var _gaq = _gaq || [];
        ...
        <style type="text/css" id="holderjs-style"></style><style>#adzerk_by {display:none}
    ...
    <body>
        ...
        <div class="bs-docs-section">
            ...
            <p>Includes 200 glyphs in font format from the Glyphicon Halflings set. <a href="http://glyphicons.com/">Glyphicons</a>
                ...
                ask that you to include a link back to <a href="http://glyphicons.com/">Glyphicons</a> whenever possible.</p>
            ...
            <p>For performance reasons, all icons require a base class and 
                individual icon class. To use, place the following code just about 
                anywhere. Be sure to leave a space between the icon and text for proper 
                padding.</p>
...
<span class="nt">&lt;/button&gt;</span>
        ...
        <!-- /JavaScript --> 
        <script src="<?php echo base_url() ?>libraries/jquery/jquery-2.0.3.min.js"></script>
        <script src="<?php echo base_url() ?>libraries/bootstrap_3.0.2/js/bootstrap.min.js"></script>
    </body>
</html>