    ...
    <div class="row">
        <div class="col-xs-12 thumbnail">
            <form role="form" method="post" action="{action_crear}" id="formulario">
                <div class="row">
                    <legend>Anular pago a proveedor</legend><p class="required_alert"><em class="required_asterisco">*</em> Campos Obligatorios</p> 
                    <div class="row">
                        <div class="col-xs-6 col-xs-offset-3">
                            <legend>Pago a proveedor que se anulará</legend>
                            ...
                            <div class="row text-center separar_submit">
                                ...
                                <a href='{action_recargar}' class="btn btn-default" role="button"><span class="glyphicon glyphicon-user"></span> Seleccionar otro pago a proveedor </a>
                            </div>
                        </div>
                    </div>
                </div>
                <div id="div_anular" style="display: none">
                    <div class="row">
                        <legend>Información del pago a proveedor</legend>
                        ...
                        <div class="form-group separar_submit">
                            ...
                            <center>
                                ...
                                <button id="btn_validar" class="btn btn-success">Anular pago a proveedor</button>  
...
<script type="text/javascript">
    $("form").delegate("#consultar_transaccion", "click", function() {
        ...
        if ((prefijo != "default") && (id != "")) {
            ...
            $("#validacion_inicial").html('<div class="alert alert-warning" id="div_warning"></div>');
            $("#div_warning").html("<p><strong><center>Antes de consultar, ingrese el prefijo y el consecutivo del pago a proveedor que se anulará.</center></strong></p>");
            $("#div_warning").delay(8000).fadeOut(1000);
        }
    });
