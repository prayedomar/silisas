...
class Empleadom extends CI_Model {
    ...
    public function cantidad_empleados_llamados_atencion($criterios, $inicio, $filasPorPagina) {
        $query = "SELECT count(*) cantidad
                  FROM empleado e
                  JOIN t_dni td ON e.dni=td.id
    ...
    public function listar_empleados_llamados_atencion($criterios, $inicio, $filasPorPagina) {
