...
class Index_admon_sistema extends CI_Controller {
    ...
    function crear_empleado() {
        ...
        $data['action_llena_cargo_departamento'] = base_url() . "index_admon_sistema/llena_cargo_departamento";
        $data['action_llena_jefe_new_empleado'] = base_url() . "index_admon_sistema/llena_jefe_new_empleado";
        $data['action_llena_provincia'] = base_url() . "index_admon_sistema/llena_provincia";
        $data['action_llena_ciudad'] = base_url() . "index_admon_sistema/llena_ciudad";
        $data['action_llena_salario_departamento'] = base_url() . "index_admon_sistema/llena_salario_departamento";
    ...
    function crear_cliente() {
        ...
        $data['ciudad'] = $this->select_model->ciudad();
        $data['t_domicilio'] = $this->select_model->t_domicilio();
        $data['action_validar'] = base_url() . "index_admon_sistema/validar_cliente";
        $data['action_crear'] = base_url() . "index_admon_sistema/new_cliente";
        $data['action_llena_provincia'] = base_url() . "index_admon_sistema/llena_provincia";
        $data['action_llena_ciudad'] = base_url() . "index_admon_sistema/llena_ciudad";
        $this->parser->parse('crear_cliente', $data);
        $this->load->view('footer');
    }
    ...
    function new_cliente() {
        if ($this->input->post('submit')) {
            ...
            $error1 = $this->insert_model->new_usuario($id, $dni, $t_usuario, $password, $perfil, $vigente);
            $data = $this->navbar();
            $data['url_recrear'] = base_url() . "index_admon_sistema/crear_cliente";
    ...
    function crear_alumno() {
        ...
        $data['action_validar'] = base_url() . "index_admon_sistema/validar_alumno";
        $data['action_crear'] = base_url() . "index_admon_sistema/new_alumno";
        $data['action_llena_provincia'] = base_url() . "index_admon_sistema/llena_provincia";
        $data['action_llena_ciudad'] = base_url() . "index_admon_sistema/llena_ciudad";
        $this->parser->parse('crear_alumno', $data);
        $this->load->view('footer');
    }
    ...
    function validar_alumno() {
        if ($this->input->is_ajax_request()) {
            ...
            $this->form_validation->set_rules('comprension_ini', 'Comprensión Inicial', 'required|trim|xss_clean|max_length[6]|callback_miles_numeric|callback_porcentaje');
    ...
    function new_alumno() {
        if ($this->input->post('submit')) {
            ...
            $error1 = $this->insert_model->new_usuario($id, $dni, $t_usuario, $password, $perfil, $vigente);
            $data = $this->navbar();
            $data['url_recrear'] = base_url() . "index_admon_sistema/crear_alumno";
    ...
    function crear_proveedor() {
        ...
        $data['ciudad'] = $this->select_model->ciudad();
        $data['t_domicilio'] = $this->select_model->t_domicilio();
        $data['action_validar'] = base_url() . "index_admon_sistema/validar_proveedor";
        $data['action_crear'] = base_url() . "index_admon_sistema/new_proveedor";
        $data['action_llena_provincia'] = base_url() . "index_admon_sistema/llena_provincia";
        $data['action_llena_ciudad'] = base_url() . "index_admon_sistema/llena_ciudad";
        $this->parser->parse('crear_proveedor', $data);
        $this->load->view('footer');
    }
    ...
    function new_proveedor() {
        ...
        if ($this->input->post('submit')) {
            ...
            $data = $this->navbar();
            $data['url_recrear'] = base_url() . "index_admon_sistema/crear_proveedor";
    ...
    function crear_titular() {
        ...
        $data['ciudad'] = $this->select_model->ciudad();
        $data['t_domicilio'] = $this->select_model->t_domicilio();
        $data['action_validar'] = base_url() . "index_admon_sistema/validar_titular";
        $data['action_crear'] = base_url() . "index_admon_sistema/new_titular";
        $data['action_llena_provincia'] = base_url() . "index_admon_sistema/llena_provincia";
        $data['action_llena_ciudad'] = base_url() . "index_admon_sistema/llena_ciudad";
        $this->parser->parse('crear_titular', $data);
        $this->load->view('footer');
    }
    ...
    function new_titular() {
        ...
        if ($this->input->post('submit')) {
            ...
            $error1 = $this->insert_model->new_usuario($id, $dni, $t_usuario, $password, $perfil, $vigente);
            $data = $this->navbar();
            $data['url_recrear'] = base_url() . "index_admon_sistema/crear_titular";
    ...
    function crear_salario() {
        ...
        $data['action_llena_t_concepto_salario'] = base_url() . "index_admon_sistema/llena_t_concepto_salario";
    ...
    function new_salario() {
        ...
        if ($this->input->post('submit')) {
            ...
            $data = $this->navbar();
            $data['url_recrear'] = base_url() . "index_admon_sistema/crear_salario";
...
//Crear: Sede Secundaria
    ...
    //Crear: Despachar Placa
    function crear_despachar_placa() {
        $data = $this->navbar();

        $data['action_validar'] = base_url() . "index_admon_sistema/validar_despachar_placa";
        $data['action_crear'] = base_url() . "index_admon_sistema/new_despachar_placa";

        $data['action_llenar_placas'] = base_url() . "index_admon_sistema/llena_solicitud_placa";
    ...
    function validar_despachar_placa() {
        if ($this->input->is_ajax_request()) {
            $this->form_validation->set_rules('observacion', 'Observación', 'trim|xss_clean|max_length[255]');
...
//Crear: Caja
    function crear_caja() {
        ...
        $data['action_validar'] = base_url() . "index_admon_sistema/validar_caja";
        $data['action_crear'] = base_url() . "index_admon_sistema/new_caja";
        $data['action_llena_t_caja_sede'] = base_url() . "index_admon_sistema/llena_t_caja_sede";
        $data['action_llena_encargado_sede'] = base_url() . "index_admon_sistema/llena_encargado_sede";
        $this->parser->parse('crear_caja', $data);
        $this->load->view('footer');
    }
    ...
    function new_caja() {
        if ($this->input->post('submit')) {
            ...
            $data = $this->navbar();
            $data['url_recrear'] = base_url() . "index_admon_sistema/crear_caja";
